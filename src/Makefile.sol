...
NPFLAGS= -g -DSUN
PFLAGS= -g -DSUN -pg
XLIB= -L/opt/sfw/lib -R/opt/sfw/lib -lncurses -ltermcap -lsocket -lxnet
...
newedit: $(BFILES)
	...
	gcc -o newedit $(CFLAGS) $(BINDFLAGS) $(BFILES) $(XLIB)
...
profedit: $(BFILES)
	-rm profedit
	gcc -o profedit $(CFLAGS) $(OBJS) $(LOBJ) $(SLIB) -ltermcap

recover: recover.c editor.h tempmod.h linemod.h bufmod.h cmds.h
	-rm recover
	gcc -o recover $(CFLAGS) $(BINDFLAGS) recover.c
